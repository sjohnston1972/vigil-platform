...
def _pin_coordinator_main():
    """Ensure sys.modules["main"] is this service's main.py for every test."""
    saved_main = sys.modules.pop("main", None)
    # Temporarily promote our directory to front of sys.path so that
    # 'import main' resolves to this service, regardless of what other
    # service conftest files have prepended.
    try:
